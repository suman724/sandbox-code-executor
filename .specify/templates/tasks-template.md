...
- [ ] T004 Create Makefile with build/test/lint/format/run targets
- [ ] T005 Add AGENTS.md with workflow and project conventions
...
- [ ] T021 [P] [US2] Unit test for [component] in tests/unit/test_[name].py
...
- [ ] T028 [P] [US3] Unit test for [component] in tests/unit/test_[name].py
